...
public class TagManager 
{
    ...
    public static string VERTICAK_AXIS = "Vertical";

    public static string FACE_X_ANIMATION_PARAMETER = "FaceX";
    public static string FACE_Y_ANIMATION_PARAMETER = "FaceY";
    public static string SHOOT_ANIMATION_PARAMATER = "Shoot";
    public static string EXPLODE_ANIMATION_PARAMATER = "Explode";
    public static string WALK_ANIMATION_PARAMATER = "Walk";
    public static string DEATH_ANIMATION_PARAMATER = "Death";
    public static string OPEN_ANIMATION_PARAMATER = "Open";
